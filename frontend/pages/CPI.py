...
cpi_content = html.Div(
    ...
    children=[
        ...
        html.Div(
            children=[
                html.H3(
                    f"Latest Year over Year CPI percentage change as of {get_latest_month()}: {get_latest_cpi()}%",
                    style={
                        "color": "white",
                        "fontWeight": "600",
                        "fontSize": "18px",
        ...
        html.Div(
            children=[
                html.H3(
                    f"Latest Year over Year Core-CPI percentage change as of {get_latest_core_month()}: {get_latest_core_cpi()}%",
                    style={
                        "color": "white",
                        "fontWeight": "600",
                        "fontSize": "18px",
